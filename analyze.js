...
2. 사이즈 — 사이즈, 치수, 호수 관련 표현
3. 새상품 여부 — 새상품, 미사용, 선물, 데드스톡 관련 표현 + 새상품으로 기재된 경우 사용감 관련 표현(몇 번 사용, 잠깐 착용 등)도 함께 발췌
4. 제조 연식 각인 — 시리얼, 제조년도, 각인, 날짜 관련 표현
5. 기재 구성품 — 케이스, 박스, 보증서, 쇼핑백, 부속품 관련 표현
6. 수선/각인 여부 — 수선, 수리, 이니셜, 각인, 커스텀 관련 표현
7. 하자 기재 여부 — 실제 파손, 스크래치, 찍힘, 깨짐, 찢김, 변형, 오염 등 물리적 손상 표현만 발췌. 단순 사용감(사용감 있음, 중고 등) 표현은 발췌하지 않음
