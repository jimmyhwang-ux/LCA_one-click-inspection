...
3. 새상품 여부 — 새상품, 미사용, 미착용, 선물, 데드스톡 관련 표현 + 새상품/미사용으로 기재된 경우에 한해, 실제 착용/사용 행위를 나타내는 표현(몇 번 착용, 잠깐 사용, 한 번 써봄 등)도 함께 발췌. 단, "새상품", "미사용", "미착용", "선물", "데드스톡" 중 하나라도 본문에 없으면 착용 횟수나 사용 표현이 있어도 절대 발췌하지 말 것. "안 신고", "못 신고", "거의 안 쓰고", "실착 N회 미만" 처럼 부정·제한 표현도 새상품으로 발췌하지 말 것. 제품 자체의 소재·가공·디자인 설명은 이 항목에 포함하지 말 것. "더스트백"은 구성품이므로 절대 이 항목에 포함하지 말 것. "거의 새상품", "준새상품", "새상품급", "새상품 수준", "새상품 같은" 처럼 새상품에 준하는 표현은 새상품으로 발췌하지 말고 ❌로 처리
